...
const calculateAverage = (arr) => {
  ...
  return calcArr.sum / calcArr.count;
};
...
Write a function named extractChildren that, given the array of characters from challenge 7, accomplishes the following:
...
const extractChildren = (arr) => {
  return arr
    .filter((cur) => {
      return cur.name.includes("a") && cur.children !== undefined;
    })
    .reduce((acc, cur) => {
      cur = cur.children;
